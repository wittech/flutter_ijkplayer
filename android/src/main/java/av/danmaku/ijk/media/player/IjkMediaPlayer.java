...
package av.danmaku.ijk.media.player;
...
import av.danmaku.ijk.media.player.misc.ITrackInfo;
import av.danmaku.ijk.media.player.misc.IjkTrackInfo;
import av.danmaku.ijk.media.player.pragma.DebugLog;
import av.danmaku.ijk.media.player.annotations.AccessedByNative;
import av.danmaku.ijk.media.player.annotations.CalledByNative;
import av.danmaku.ijk.media.player.misc.IAndroidIO;
import av.danmaku.ijk.media.player.misc.IMediaDataSource;
...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private void initPlayer(IjkLibLoader libLoader) {
         ...
         *
         *
         * up requires a weak reference to our object. It's easier to
    ...
    public void setSurface(Surface surface) {
        if (mScreenOnWhilePlaying && surface != null) {
            av.danmaku.ijk.media.player.pragma.DebugLog.w(TAG,
    ...
    @Override
    public av.danmaku.ijk.media.player.misc.IjkTrackInfo[] getTrackInfo() {
        ...
        ArrayList<av.danmaku.ijk.media.player.misc.IjkTrackInfo> trackInfos = new ArrayList<av.danmaku.ijk.media.player.misc.IjkTrackInfo>();
        for (IjkMediaMeta.IjkStreamMeta streamMeta: mediaMeta.mStreams) {
            av.danmaku.ijk.media.player.misc.IjkTrackInfo trackInfo = new av.danmaku.ijk.media.player.misc.IjkTrackInfo(streamMeta);
            if (streamMeta.mType.equalsIgnoreCase(IjkMediaMeta.IJKM_VAL_TYPE__VIDEO)) {
                trackInfo.setTrackType(av.danmaku.ijk.media.player.misc.ITrackInfo.MEDIA_TRACK_TYPE_VIDEO);
            } else if (streamMeta.mType.equalsIgnoreCase(IjkMediaMeta.IJKM_VAL_TYPE__AUDIO)) {
                trackInfo.setTrackType(av.danmaku.ijk.media.player.misc.ITrackInfo.MEDIA_TRACK_TYPE_AUDIO);
            } else if (streamMeta.mType.equalsIgnoreCase(IjkMediaMeta.IJKM_VAL_TYPE__TIMEDTEXT)) {
                trackInfo.setTrackType(av.danmaku.ijk.media.player.misc.ITrackInfo.MEDIA_TRACK_TYPE_TIMEDTEXT);
            }
    ...
    public int getSelectedTrack(int trackType) {
        switch (trackType) {
            case av.danmaku.ijk.media.player.misc.ITrackInfo.MEDIA_TRACK_TYPE_VIDEO:
                return (int)_getPropertyLong(FFP_PROP_INT64_SELECTED_VIDEO_STREAM, -1);
            case av.danmaku.ijk.media.player.misc.ITrackInfo.MEDIA_TRACK_TYPE_AUDIO:
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_ERROR:
                av.danmaku.ijk.media.player.pragma.DebugLog.e(TAG, "Error (" + msg.arg1 + "," + msg.arg2 + ")");
            ...
            case MEDIA_INFO:
                switch (msg.arg1) {
                    case MEDIA_INFO_VIDEO_RENDERING_START:
                        av.danmaku.ijk.media.player.pragma.DebugLog.i(TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                        break;
                }
            ...
            default:
                av.danmaku.ijk.media.player.pragma.DebugLog.e(TAG, "Unknown message type " + msg.what);
            }
        }
    }
